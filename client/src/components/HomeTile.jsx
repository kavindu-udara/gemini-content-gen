...
const HomeTile = ({icon, title, description}) => {
  return (
    <div className='p-6 rounded-lg bg-white dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-gray-600 cursor-pointer'>
        <button className="text-3xl p-3 rounded-lg bg-blue-500 text-white mb-3">{icon}</button>
